...
import wtf.base.client.util.render.animation.Delta;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        try {
            ...
            logger.fatal("Client failed to start! Stack trace below");
            e.printStackTrace();
        }
    ...
    public void runTick() throws IOException
    {
        ...
        if (theWorld != null && thePlayer != null) {
            Client.BUS.post(new ClientTickEvent(Era.PRE));
        }
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                Client.BUS.post(new KeyInputEvent(k, Keyboard.getEventKeyState()));
        ...
        if (theWorld != null && thePlayer != null) {
            Client.BUS.post(new ClientTickEvent(Era.POST));
        }
